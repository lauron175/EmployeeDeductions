...
$(document).ready(function () {
    ...
    class CalculatedBenefitCosts {
        totalDeductions: string;    
        annualSalary: string;
        salaryAfterDeductions: string;        
    }
    ...
    function displayCalculatedCosts(annualSalary: number, totalBenefitCost: number) {
    ...
    $(".btn-calculate").click(function () {
        ...
        $.ajax({
            type: "GET",
            url: "/employee/CalculateBenefitsCost?employeeId=" + employeeId,//normally this would be an api call
    ...
    $("#btnAddDependent").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "/dependent/Create/",//normally this would be an api call            
            data: dependent,
            success: function (data) {
